...
Public Class Form4
    ...
    Private Sub grabaaux()
        ...
        conexion1.Open()
        Dim consulta As String = "insert into alumnosaplaz(N_legajo, Division, Materia, P_cuatrimestre, S_cuatrimestre, T_cuatrimestre, Promedio, Condicion)" & "values('" & N_legajom & "','" & Divisionm & "','" & Materiam & "','" & P_cuatrimestrem & "','" & S_cuatrimestrem & "','" & T_cuatrimestrem & "','" & Promf & "','" & Estadom & "')"
    ...
    Private Sub Limpiar()
        con.Open()
        Dim borra As String = "DELETE*From alumnosaplaz"
    ...
    Private Sub Form4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the '_tablas_colegioAPLAZADOS.alumnosaplaz' table. You can move, or remove it, as needed.
        Me.AlumnosaplazTableAdapter.Fill(Me._tablas_colegioAPLAZADOS.alumnosaplaz)
