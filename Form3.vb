...
Public Class Form3
    ...
    Private Sub Btnlect_Click(sender As Object, e As EventArgs) Handles Btnlect.Click
        ...
        Do While contar < lista
            ...
            If Promf <= 6 And Promf >= 4 Then 'DESAPROBADOS
    ...
    Private Sub grabaaux()
        ...
        conexion1.Open()
        Dim consulta As String = "insert into alumnosdes(N_legajo, Division, Materia, P_cuatrimestre, S_cuatrimestre, T_cuatrimestre, Promedio, Condicion)" & "values('" & N_legajom & "','" & Divisionm & "','" & Materiam & "','" & P_cuatrimestrem & "','" & S_cuatrimestrem & "','" & T_cuatrimestrem & "','" & Promf & "','" & Estadom & "')"
    ...
    Private Sub Limpiar()
        con.Open()
        Dim borra As String = "DELETE*From alumnosdes"
    ...
    Private Sub Form3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the '_tablas_colegioDataSetDESAPROBADOS.alumnosdes' table. You can move, or remove it, as needed.
        Me.AlumnosdesTableAdapter.Fill(Me._tablas_colegioDataSetDESAPROBADOS.alumnosdes)
